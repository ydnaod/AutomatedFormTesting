...
const testForms = async () => {
  ...
  await page.goto('http://m.thebeautyinstituteskp.edu/campus/ambler-beauty-schools/esthetics?lead_src=google-mobile');
  ...
  await page.goto('http://m.thebeautyinstituteskp.edu/campus/ambler-beauty-schools/cosmetology?lead_src=google-mobile');
  await page.type('#ambler_firstname', 'AndyTestGoogle'); 
  ...
  await page.goto('http://m.thebeautyinstituteskp.edu/campus/philadelphia-beauty-schools/esthetics?lead_src=google-mobile');
  await page.type('#ambler_firstname', 'AndyTestGoogle'); 
  ...
  await page.goto('http://m.thebeautyinstituteskp.edu/campus/philadelphia-beauty-schools/cosmetology?lead_src=google-mobile');
  await page.type('#ambler_firstname', 'AndyTestGoogle'); 
